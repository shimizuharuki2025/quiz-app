        ...
        try {
            ...
            if (data.success) {
                if (data.dbError) {
                    ...
                    errorBanner.innerHTML = '<span class="material-icons" style="vertical-align: middle; margin-right: 5px;">error</span> データベースに接続できません。一部の機能が制限されています（ユーザー管理などは使用できません）。';
